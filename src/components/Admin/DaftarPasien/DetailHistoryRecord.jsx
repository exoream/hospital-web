  ...
  const fetchRiwayat = async () => {
    try {
      ...
      const resRiwayat = await fetch(
        `https://hospital-be-chi.vercel.app/api/admin/riwayat-pasien/${id}?page=${page}&limit=${limit}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
                  ...
                  {riwayat.length > 0 ? (
                    riwayat.map((r, idx) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">
                          {new Date(r.riwayat_created_at).toLocaleDateString(
                            "id-ID",
                            {
                              day: "numeric",
                              month: "long",
                          ...
                          {r.catatan ? (
                            <>
                              ...
                              <div className="text-xs text-gray-400 mt-1">
                                Catatan ditulis pada tanggal{" "}
                                {new Date(
                                  r.catatan_created_at
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">
                          {r.jadwal_keterangan ? (
                            ...
                            <span className="italic text-gray-400">
                              Tidak ada ringkasan hasil kunjungan
                            </span>
                          )}
                        </td>
                      </tr>
