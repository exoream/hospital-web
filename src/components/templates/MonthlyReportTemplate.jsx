...
const MonthlyReportTemplate = ({ report }) => {
    const monthLabel = monthNames[report?.bulan] || 'Bulan Tidak Diketahui';
    ...
    return (
        <div className="p-8 bg-white text-black max-w-[800px] mx-auto print-area printable">
            {/* <div className="text-center border-b-2 border-black pb-4 mb-6">
                ...
                <h3 className="text-lg font-semibold underline underline-offset-4 mt-4">LAPORAN BULANAN KESEHATAN LANSIA</h3>
                <p className="text-sm">Periode: {monthLabel} {report?.tahun || new Date().getFullYear()}</p>
            </div> */}
            ...
            <div className="mb-6">
                ...
                <p className="text-sm mb-2">Puji syukur kehadirat Allah SWT atas segala rahmat dan hidayah-Nya, sehingga kami dapat menyelesaikan Laporan Bulanan Kesehatan Lansia ini dengan baik.</p>
                <p className="text-sm">Laporan ini disusun sebagai bentuk pertanggungjawaban pelaksanaan program kesehatan lansia di wilayah kerja Puskesmas Kecamatan selama bulan {monthLabel} tahun {report?.tahun}.</p>
            </div>
            ...
            <div className="mb-6">
                <h4 className="font-semibold mb-2 ">ANALISIS KUNJUNGAN PER HARI</h4>
                <div className="text-sm border border-black p-3">
                    <p className="mb-2">Berikut adalah data kunjungan pasien lansia selama bulan {monthLabel}:</p>
                    {Array.isArray(report?.kunjungan_per_hari) && report.kunjungan_per_hari.length > 0 ? (
                        <table className="w-full border-collapse">
                            ...
                            <tbody>
                                {report.kunjungan_per_hari.map((k, i) => (
                                    <tr key={i} className="border-b border-gray-300">
                                        <td className="py-1">Tanggal {k.hari}</td>
            ...
            <div className="mb-6">
                ...
                <p className="text-sm py-2">Demikian laporan bulanan kesehatan lansia ini kami susun sebagai bahan evaluasi dan perencanaan program kesehatan lansia di masa mendatang. Semoga laporan ini dapat bermanfaat bagi semua pihak yang berkepentingan.</p>
            </div>
