...
const Header = () => {
    ...
    const fetchNotifikasi = async () => {
        try {
            ...
            const res = await fetch("http://localhost:3000/api/pasien/notifikasi", {
    ...
    const markAllNotifikasiAsRead = async () => {
        try {
            const token = await getToken();
            await fetch("http://localhost:3000/api/pasien/notifikasi/baca", {
                method: "PATCH",
                headers: { Authorization: `Bearer ${token}` },
            });
        } catch (err) {
                                                    ...
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="font-medium text-gray-900">
                                                                Jadwal kunjungan: {item.tanggal_kunjungan} pukul {item.waktu}
                                                            </div>
...
const Content = ({ activeMenu, setActiveMenu }) => {
    ...
    const fetchNotifikasi = async (page, limit, tanggalFilter) => {
        try {
            ...
            const res = await fetch(`http://localhost:3000/api/pasien/all-notifikasi?${query.toString()}`, {
                headers: {
    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                const token = await getToken();
                const res = await fetch(`http://localhost:3000/api/pasien/dashboard`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
        ...
        return (
            <div className="p-6">
                <div className="mb-6">
                    ...
                    <p className="text-gray-500 text-sm">Selamat datang di Sistem Informasi Puskesmas Camba</p>
                </div>
